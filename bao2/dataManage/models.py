...
class boke(models.Model):
    ...
    user_id = models.OneToOneField(user1,on_delete=None,verbose_name='博客主人')
    def __srt__(self):
...
class ensure(models.Model):
    ...
    T_time = models.DateTimeField(verbose_name='处理时间',null=True)
    class Meta:
        verbose_name = "报障单"
...
#     # boke_id = models.ForeignKey(boke,verbose_name='所属博客',on_delete=models.SET_NULL,null=True)
#     boke_i = models.ForeignKey(boke,verbose_name="所属博客",on_delete=models.SET_NULL,null=True,blank=True)
#     class Meta:
#         verbose_name = "分类表"
#         verbose_name_plural ="分类表"
class fenlei(models.Model):

     label = models.CharField(max_length=20,verbose_name="分类名")
...
class article(models.Model):
    ...
    C_time = models.DateTimeField(verbose_name="创建时间")
    c_id = models.OneToOneField(fenlei,on_delete=None,parent_link=True,verbose_name='分类')
